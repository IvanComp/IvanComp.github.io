...
<div class="awards-page">
  <article class="award-feature">
    <div class="award-feature__content">
      <p class="award-feature__eyebrow">Best Paper Award</p>
      <h2 class="award-feature__title">Demonstrations and Resources Forum (BPM'23)</h2>
      <p class="award-feature__summary">
        <strong>BPMN Inspector</strong> was awarded at the 21st International Conference on Business Process Management, held on September 11-15, 2023.
      </p>

      <dl class="award-feature__meta">
        <div>
          <dt>Paper</dt>
